        ...
        <AnimatePresence mode="wait">
          ...
          >
            <motion.div
              ...
              className="space-y-6"
            >
              <motion.h2 className="text-5xl font-bold text-center mb-7 text-[#ffd700] drop-shadow-[0_0_6px_rgba(255,215,0,0.4)]">
              ...
              {isRegister ? (
                <>
                  <motion.input
                    ...
                    className="w-full mb-4 p-3 bg-[#2a2421] text-[#f4ede6] placeholder:text-sm placeholder-[#d2b49c] border border-[#ffd700] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ffd700] focus:ring-opacity-60"
                    placeholder="Reg No"
                  />
...
*/}
                ...
                <>
                  ...
                  <motion.a
                    ...
                    animate="visible"
                    href="#"
                    className="block mt-2 text-right text-sm text-[#ffd700] hover:underline"
                  >
                    Forgot Password?
                  </motion.a>
                </>
